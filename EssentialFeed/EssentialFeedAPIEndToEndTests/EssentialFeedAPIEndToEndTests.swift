...
final class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGETFeedResult_matchesFixedTestAccountData() {
        ...
        case .failure(let error):
            XCTFail("Expected sucessfull feed result got an \(error) instead!")
        default:
            XCTFail("Expected sucessfull feed result got no result instead!")
        }
    }
    ...
    private func getFeedResult(file: StaticString = #filePath,
        ...
        let exp = expectation(description: "Wait for the loader!")
